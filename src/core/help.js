...
export const COMMAND_CATEGORIES = {
  ...
  dispatch: 'admin',
  patrol: 'admin',
  // S70/S106: config groups carry their short Red-style names in the menu.
  // Every retired spelling — `-config`, and the hyphenated pairs S106 folded
  // in (`!trivia scores`, `!ranks setup`, …) — still works as an alias but is
  // not listed: the roster shows one name per family.
  xp: 'admin',
  ai: 'admin',
  birthday: 'admin',
  memorial: 'admin',
